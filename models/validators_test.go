...
func validatorBeforeInsertHook(ctx context.Context, e boil.ContextExecutor, o *Validator) error {
	*o = Validator{}
	return nil
}

func validatorAfterInsertHook(ctx context.Context, e boil.ContextExecutor, o *Validator) error {
	*o = Validator{}
	return nil
}

func validatorAfterSelectHook(ctx context.Context, e boil.ContextExecutor, o *Validator) error {
	*o = Validator{}
	return nil
}

func validatorBeforeUpdateHook(ctx context.Context, e boil.ContextExecutor, o *Validator) error {
	*o = Validator{}
	return nil
}

func validatorAfterUpdateHook(ctx context.Context, e boil.ContextExecutor, o *Validator) error {
	*o = Validator{}
	return nil
}

func validatorBeforeDeleteHook(ctx context.Context, e boil.ContextExecutor, o *Validator) error {
	*o = Validator{}
	return nil
}

func validatorAfterDeleteHook(ctx context.Context, e boil.ContextExecutor, o *Validator) error {
	*o = Validator{}
	return nil
}

func validatorBeforeUpsertHook(ctx context.Context, e boil.ContextExecutor, o *Validator) error {
	*o = Validator{}
	return nil
}

func validatorAfterUpsertHook(ctx context.Context, e boil.ContextExecutor, o *Validator) error {
	*o = Validator{}
	return nil
}

func testValidatorsHooks(t *testing.T) {
	t.Parallel()
	...
	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, o, validatorDBTypes, false); err != nil {
		t.Errorf("Unable to randomize Validator object: %s", err)
	}

	AddValidatorHook(boil.BeforeInsertHook, validatorBeforeInsertHook)
	...
	validatorBeforeInsertHooks = []ValidatorHook{}

	AddValidatorHook(boil.AfterInsertHook, validatorAfterInsertHook)
	...
	validatorAfterInsertHooks = []ValidatorHook{}

	AddValidatorHook(boil.AfterSelectHook, validatorAfterSelectHook)
	...
	validatorAfterSelectHooks = []ValidatorHook{}

	AddValidatorHook(boil.BeforeUpdateHook, validatorBeforeUpdateHook)
	...
	validatorBeforeUpdateHooks = []ValidatorHook{}

	AddValidatorHook(boil.AfterUpdateHook, validatorAfterUpdateHook)
	...
	validatorAfterUpdateHooks = []ValidatorHook{}

	AddValidatorHook(boil.BeforeDeleteHook, validatorBeforeDeleteHook)
	...
	validatorBeforeDeleteHooks = []ValidatorHook{}

	AddValidatorHook(boil.AfterDeleteHook, validatorAfterDeleteHook)
	...
	validatorAfterDeleteHooks = []ValidatorHook{}

	AddValidatorHook(boil.BeforeUpsertHook, validatorBeforeUpsertHook)
	...
	validatorBeforeUpsertHooks = []ValidatorHook{}

	AddValidatorHook(boil.AfterUpsertHook, validatorAfterUpsertHook)
	...
	validatorAfterUpsertHooks = []ValidatorHook{}
}
...
func testValidatorToManyValidatorAddressPreCommits(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = randomize.Struct(seed, &b, preCommitDBTypes, false, preCommitColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	if err = randomize.Struct(seed, &c, preCommitDBTypes, false, preCommitColumnsWithDefault...); err != nil {
		t.Fatal(err)
	}
	...
	check, err := a.ValidatorAddressPreCommits().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := ValidatorSlice{&a}
	if err = a.L.LoadValidatorAddressPreCommits(ctx, tx, false, (*[]*Validator)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.ValidatorAddressPreCommits); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
	}

	a.R.ValidatorAddressPreCommits = nil
	if err = a.L.LoadValidatorAddressPreCommits(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.ValidatorAddressPreCommits); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testValidatorToManyAddOpValidatorAddressPreCommits(t *testing.T) {
	var err error
	...
	var a Validator
	var b, c, d, e PreCommit

	seed := randomize.NewSeed()
	if err = randomize.Struct(seed, &a, validatorDBTypes, false, strmangle.SetComplement(validatorPrimaryKeyColumns, validatorColumnsWithoutDefault)...); err != nil {
		t.Fatal(err)
	}
	foreigners := []*PreCommit{&b, &c, &d, &e}
	for _, x := range foreigners {
		if err = randomize.Struct(seed, x, preCommitDBTypes, false, strmangle.SetComplement(preCommitPrimaryKeyColumns, preCommitColumnsWithoutDefault)...); err != nil {
			t.Fatal(err)
		}
	}
	...
	foreignersSplitByInsertion := [][]*PreCommit{
		{&b, &c},
		{&d, &e},
	}

	for i, x := range foreignersSplitByInsertion {
		err = a.AddValidatorAddressPreCommits(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		if a.R.ValidatorAddressPreCommits[i*2] != first {
			t.Error("relationship struct slice not set to correct value")
		}
		if a.R.ValidatorAddressPreCommits[i*2+1] != second {
			t.Error("relationship struct slice not set to correct value")
		}

		count, err := a.ValidatorAddressPreCommits().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
