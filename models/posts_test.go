...
var (
	postDBTypes = map[string]string{`ID`: `uuid`, `Height`: `bigint`, `VendorID`: `integer`, `PostID`: `text`, `Creator`: `text`, `RewardAddress`: `text`, `Timestamp`: `timestamp without time zone`, `CurationEndTime`: `timestamp without time zone`, `Body`: `text`, `TotalVotes`: `integer`, `TotalVotesAmount`: `bigint`, `TotalVotesDenom`: `text`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`, `DeletedAt`: `timestamp without time zone`, `TotalVoterCount`: `integer`, `TotalUpvoteRewardAmount`: `bigint`, `TotalUpvoteRewardDenom`: `text`, `TotalStakedAmount`: `bigint`, `BodyHash`: `text`, `ChainID`: `text`, `Owner`: `text`, `ContractAddress`: `text`, `Metadata`: `text`, `Locked`: `boolean`, `ParentID`: `text`, `TX`: `text`}
	_           = bytes.MinRead
)
