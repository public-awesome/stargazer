...
type Post struct {
	...
	AuthorAddress null.String `boil:"author_address" json:"authorAddress,omitempty" toml:"authorAddress" yaml:"authorAddress,omitempty"`
...
var PostWhere = struct {
	...
	AuthorAddress: whereHelpernull_String{field: "\"posts\".\"author_address\""},
...
var (
	postAllColumns            = []string{"id", "vendor_id", "author_address", "created_at", "updated_at", "deleted_at"}
	postColumnsWithoutDefault = []string{"vendor_id", "author_address", "deleted_at"}
